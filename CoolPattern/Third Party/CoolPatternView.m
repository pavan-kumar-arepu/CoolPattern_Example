...
{    
    UIColor * dotColor = [UIColor colorWithHue:2 saturation:3 brightness:0.07 alpha:1.0];
...
- (void)drawRect:(CGRect)rect
{
    ...
    UIColor * bgColor = [UIColor colorWithHue:1 saturation:3
                                   brightness:2 alpha:1.0];
